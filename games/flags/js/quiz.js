import { QuizEngine } from '../../assets/js/engine.js?v=09251504';
import { makeSpeaker } from '../../assets/js/pronunciation.js?v=09251504';
import { buildQuestions, describe, byRegion, WORLD_COUNT, GLOBE, applyResult, weakness, explainPair, checkTypein, tidbitFor } from './build.js?v=09251504';
import { REGIONS } from './data.js?v=09251504';
